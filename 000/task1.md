...
Mengetahui contoh dan kegunaan AI pada platform browser.
Mengenal konsep, mekanisme kerja, dan jenis-jenis Computer Vision untuk platform browser.
Memberikan nilai tambah pada aplikasi menggunakan Generative AI .
...
Mengintegrasikan model dengan TensorFlow.js untuk membangun sebuah aplikasi yang dapat mengenali objek yang sudah dilatih.
Mengintegrasikan model open source dengan bantuan Transformers.js untuk menambahkan kemampuan Generative AI pada aplikasi.
Mengintegrasikan model Computer Vision dan Generative AI untuk menambah nilai pada suatu aplikasi.
...
Si Mata (Computer Vision): Menggunakan kamera untuk mengenali berbagai jenis sayuran.
Si Otak (Generative AI): Setelah sayuran dikenali, ia akan menceritakan fakta menarik (fun fact) yang unik tentang sayuran tersebut.
...
Starter Project (Basic): starter-project-basic.zip
Starter Project (MVP): starter-project-mvp.zip
Starter Project (React): starter-project-react.zip
...
Bukalah proyek tersebut pada teks editor pilihan Anda.
Jalankanmenggunakan dua opsi berikut:
Menggunakan Extension VS Code: Live Server
dos-1b545e987012dddf3a3570bbe0fe28e720260219140856.jpeg
Menggunakan Node.js Live Server
dos-02b0d6c5998b94bdb26e468e90ba053b20260219140854.jpeg
(Opsional) Jika menggunakan MVP atau React
Install dependencies yang diperlukan.
npm install
Jalankan development server.
npm run start-dev // Untuk MVP
npm run dev // Untuk React
Buka browser dan akses aplikasi di http://localhost:<port> (port bisa berbeda tergantung konfigurasi).
...
Kriteria 1: Mengembangkan Fitur Deteksi Sayuran (Computer Vision)
Gunakan library TensorFlow.js yang sama dengan versi latihan. Jika terdapat pembaruan gunakan versi yang spesifik seperti berikut.
...
dos-af01cb85e1ed54191a9efd0dc7f2653d20260219140856.jpeg
Kriteria 2: Mengintegrasikan Generative AI untuk Konten Fun Fact
...
dos-dc5fc377027741905f5709f07c5c078c20260219140856.jpeg
Sebelum mengirimkan submission, pastikan berkas cache dapat ditemukan pada Cache Storage.
dos-9e2f2d9baf1755caa4d31aa272e5829320260219140856.jpeg
...
Advanced: Root Facts Apps - Advanced ( link url https://root-facts-advance.netlify.app/)
...
NOTE :
-UNTUK GAMBAR CEK DI FOLDER 000 dan cocokan dengan nama gambarnya.
-Ada task yang katanya kita sudah mempelajari hal tersebut bisa cek di folder 000/artikel.md
